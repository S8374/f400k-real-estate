...
const targetFile = path.join(__dirname, 'src', 'components', 'modules', 'home', 'FeaturedProperties.tsx');
let content = fs.readFileSync(targetFile, 'utf8');

// The file got corrupted, let's restore it completely from the known good state + the fixes.
...
function FeaturedProperties() {
  ...
  return (
    <div className=" p-4 lg:p-8 rounded bg-neutral-900/40 backdrop-blur-3xl border border-white/5">
...
console.log('Restored and fixed FeaturedProperties.tsx');
