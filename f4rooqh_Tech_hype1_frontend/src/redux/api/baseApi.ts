  ...
  if (result?.error?.status === 401) {
    if (!isRedirecting) {
      ...
      if (typeof window !== "undefined") {
        ...
        const isPublicPage = path === "/" || path.startsWith("/properties") || path.startsWith("/property/") || path === "/signup" || path === "/login" || path.startsWith("/forgot-") || path.startsWith("/verify-") || path.startsWith("/reset-");
