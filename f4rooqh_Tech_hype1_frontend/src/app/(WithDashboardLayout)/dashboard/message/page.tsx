...
export default function MessagesPage() {
  ...
  if (isLoadingConversations) {
    return (
      <div className="h-[calc(100dvh-9rem)] flex flex-col text-gray-100 overflow-hidden min-h-0 bg-stone-950/20 rounded">
        <div className="flex h-full">
          ...
          <div className="flex-1 flex flex-col p-4 space-y-6">
             <div className="flex gap-3 opacity-20 animate-pulse">
                ...
                <Skeleton className="h-16 w-64 rounded rounded-tl-none bg-white/10" />
             </div>
             <div className="flex gap-3 justify-end opacity-20 animate-pulse">
                <Skeleton className="h-16 w-56 rounded rounded-tr-none bg-emerald-500/10" />
                <Skeleton className="h-10 w-10 rounded-full bg-emerald-500/10" />
             </div>
             <div className="flex gap-3 opacity-20 animate-pulse">
                <Skeleton className="h-10 w-10 rounded-full bg-white/10" />
                <Skeleton className="h-12 w-48 rounded rounded-tl-none bg-white/10" />
             </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="h-[calc(100dvh-9rem)] flex flex-col text-gray-100 overflow-hidden min-h-0">
      ...
      <div className="flex flex-1 overflow-hidden min-h-0">
        {/* Chat List */}
        <div
          className={`rounded bg-stone-800/70 w-full lg:w-80 overflow-y-auto shrink-0 min-h-0 lg:mr-4 ${
        ...
        {/* Chat Area */}
        <div
          className={`rounded bg-stone-800/70 flex-1 flex flex-col min-h-0 overflow-hidden ${selectedChatId ? "block" : "hidden lg:block"
            }`}
        >
          {selectedChatId ? (
            <>
              ...
              <div className="p-4 shrink-0 transition-all">
                ...
                {pendingAttachment && (
                  <div className="mb-3 flex animate-in slide-in-from-bottom-2 duration-300">
                    <div className="relative group/preview rounded overflow-hidden border border-emerald-500/30 bg-emerald-950/20 p-2 pr-10 flex items-center gap-3">
