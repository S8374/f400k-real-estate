    ...
    if (savedPropertiesData.length === 0) {
        return (
            <div className="min-h-[70vh] p-6">
                <div className="relative mx-auto flex min-h-[65vh] max-w-5xl items-center justify-center overflow-hidden rounded border border-emerald-900/40 bg-[#1f1e1e] px-6 py-14">
