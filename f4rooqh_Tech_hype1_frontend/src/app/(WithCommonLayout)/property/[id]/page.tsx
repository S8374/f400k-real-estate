...
const PropertyDetailsPage = () => {
  ...
  const sortedMedia = [...(property?.images || [])].sort((a: string, b: string) => {
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-white overflow-x-hidden">
      <div className=" mx-auto px-4 py-8 lg:px-8 lg:py-12">
        ...
        <button 
          onClick={() => router.push('/')} 
          className="mb-6 flex items-center gap-2 text-zinc-400 hover:text-emerald-500 transition-colors group"
        >
        ...
        <div className="relative rounded-3xl overflow-hidden">
          ...
          >
            {sortedMedia.map((url: string, i: number) => {
