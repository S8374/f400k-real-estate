      ...
      <div className={`max-w-[88%] sm:max-w-[80%] ${msg.isYou ? "ml-auto" : ""}`}>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div
              className={`p-2.5 sm:p-3 rounded text-sm sm:text-[15px] leading-relaxed relative cursor-pointer ${msg.isYou
            ...
            >
              ...
              {msg.attachmentUrl && (
                <div className="mt-2 overflow-hidden rounded group/attach relative">
                  {msg.attachmentType === "IMAGE" ? (
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 p-3 bg-black/20 rounded hover:bg-black/40 transition-all group/doc"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <div className="p-2 bg-emerald-500/20 rounded group-hover/doc:bg-emerald-500/40 transition-colors">
