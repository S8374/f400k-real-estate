...
export default function PropertyCardMap({ property, onCardClick }: PropertyCardProps) {
  ...
  return (
    <Card className="relative z-30 w-70 max-w-70 bg-neutral-800 opacity-100 backdrop-blur-sm rounded overflow-hidden border border-yellow-500/20 hover:border-yellow-500 shadow-2xl p-0 h-full">
