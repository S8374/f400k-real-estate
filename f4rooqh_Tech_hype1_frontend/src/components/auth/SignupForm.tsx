...
export function SignupForm() {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      {/* Account Type Toggle */}
      <div className="flex bg-zinc-800/60 rounded p-1 border border-zinc-700/50 mb-6 w-full">
        <button
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full">
        ...
        >
          <div className="space-y-4 p-4 bg-zinc-900/30 rounded">
            {/* Nationality */}
            <div>
              ...
              <div className="relative">
                ...
                <select 
                  ...
                  defaultValue=""
                  className="block w-full pl-10 pr-10 py-3 bg-zinc-800/60 border border-zinc-700/50 rounded text-white focus:outline-none focus:ring-1 focus:ring-[#5e8b7e] transition-all text-sm appearance-none cursor-pointer"
                >
        ...
        {/* Security Info Box */}
        <div className="bg-zinc-900/50 border border-zinc-800 rounded p-4 flex gap-3 mt-4">
