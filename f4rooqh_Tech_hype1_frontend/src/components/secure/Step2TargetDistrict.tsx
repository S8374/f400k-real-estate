      ...
      <div className="flex gap-4 w-full items-start">
        ...
        <div className="flex-1 relative">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded border border-green-500/60 bg-green-500/5 text-white text-sm focus:outline-none"
          >
          ...
          {open && (
            <ul className="absolute z-10 mt-1 w-full bg-[#1a2a1a] border border-green-500/30 rounded overflow-hidden shadow-xl">
              {districts.map((d) => (
                <li
                  key={d}
                  onClick={() => {
        ...
        {/* Map thumbnail */}
        <div className="w-32 h-24 rounded overflow-hidden border border-white/10 shrink-0">
