              ...
              <div className="flex justify-center gap-3 md:gap-4">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className="h-14 w-14 text-center text-2xl font-bold bg-neutral-800 border border-neutral-700 rounded text-white focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition-all"
                  />
                ))}
              </div>
