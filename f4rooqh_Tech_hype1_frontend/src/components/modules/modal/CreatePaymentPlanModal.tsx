      ...
      <DialogContent className="bg-[#2E2E2E] text-white border-gray-700 max-w-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-4">
          ...
          <div className="space-y-1">
            ...
            <select
              {...register("name")}
              className="flex h-10 w-full rounded border border-gray-700 bg-[#1E1E1E] px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
              disabled
            >
