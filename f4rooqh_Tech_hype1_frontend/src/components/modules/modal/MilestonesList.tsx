...
export default function MilestonesList({
  ...
  if (error) {
    return (
      <Card className="bg-stone-900/70 border-red-500/30 rounded">
  ...
  if (!planId) {
    return (
      <Card className="bg-stone-900/70 border-stone-700 rounded">
        <CardContent className="py-12 px-4 text-center">
          <div className="flex flex-col items-center gap-3">
      ...
      {milestones.map((milestone) => {
        ...
        return (
          <Card
            key={milestone.id}
            className={`
            relative bg-[#0f0f0f] border border-[#2a2a2a] rounded overflow-hidden p-0
          ...
          >
            ...
            <CardContent className="">
              ...
              {isLocked && (
                <div className="mt-3 py-2 px-3 bg-black/40 rounded text-center text-gray-500 text-xs flex items-center justify-center gap-2">
              ...
              {isCompleted && milestone.paidAt && (
                <div className="mt-3 py-2 px-3 bg-emerald-500/10 rounded text-center text-emerald-500 text-xs">
