...
export default function PropertyDetails({ bankAccounts, propertyInvisitors }: any) {
  ...
  return (
    <div className="space-y-3">
      {/* Seller Bank Details */}
      <Card className="bg-[#1E2126] text-white border-white/10 rounded">
        ...
        <CardContent className="p-4 pt-2 space-y-3">
          {investor ? (
            <>
              ...
              <div className="flex items-center gap-2 rounded bg-emerald-900/20 border border-emerald-600/30 px-3 py-2 text-emerald-400 text-xs">
                <Shield size={14} />
