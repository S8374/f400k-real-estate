...
export default function PropertyCard({
  ...
  return (
    <div className="relative w-full rounded overflow-hidden shadow-2xl bg-neutral-900/80 backdrop-blur-xl border border-white/10 hover:scale-[1.02] hover:shadow-emerald-500/20 transition-all duration-300">
      {/* ── Image Slider ── */}
      ...
      {showLocationButton && (
        <div className="px-4 pb-4">
          <button
            ...
            className="cursor-pointer w-full rounded bg-emerald-500 px-3 py-2 text-sm font-semibold text-white transition hover:bg-emerald-400 disabled:cursor-not-allowed disabled:bg-neutral-700 disabled:text-neutral-400"
          >
            View Location
          </button>
        </div>
