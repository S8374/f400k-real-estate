...
export default function AdminDashboard({ admin }: { admin: any }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 rounded border border-zinc-800 bg-zinc-900/60 p-5 md:flex-row md:items-center md:justify-between">
        <div>
  ...
  return (
    <Card className="border-zinc-800 bg-zinc-900/80 text-white">
      <CardContent className="flex items-center justify-between p-3">
        ...
        <div className="rounded bg-emerald-500/15 p-2 text-emerald-400">{icon}</div>
      </CardContent>
    </Card>
  );
}
