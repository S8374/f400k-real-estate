...
export default function BuyerProfileProperty() {
  ...
  return (
    <div className="bg-[#2c2a2a] p-4 rounded">
      {isLoading || isFetching ? (
        ...
        <div className="min-h-[60vh]">
          <div className="relative flex min-h-[60vh] items-center justify-center overflow-hidden rounded border border-emerald-900/40 bg-[#1f1e1e] px-6 py-14">
            ...
            <div className="relative z-10 text-center">
              <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded border border-emerald-500/30 bg-emerald-500/10">
