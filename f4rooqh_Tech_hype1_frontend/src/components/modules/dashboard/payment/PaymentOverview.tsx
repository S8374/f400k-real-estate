...
export default function PaymentOverview({ property, stats }: any) {
    ...
    return (
        <div className="w-full space-y-4">
            ...
            <Card className=" border-white/10 rounded overflow-hidden">
                <CardContent className="p-3 sm:p-4">
                    <div className="flex flex-col md:flex-row md:items-center gap-3 sm:gap-4">
                        {/* Left - Image */}
                        <div className="flex items-center gap-3">
                            <div className="relative h-12 w-16 sm:h-14 sm:w-20 md:h-16 md:w-24 shrink-0 rounded overflow-hidden border border-white/10">
                                <Image
                                    src={firstImage}
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                {/* Total Price */}
                <Card className="bg-[#1F2227] border-white/10 rounded">
                ...
                {/* Verified Payments */}
                <Card className="bg-[#1F2227] border-emerald-700/60 rounded">
                    <CardContent className="p-3 sm:p-4 space-y-1.5">
                        <div className="flex items-center gap-2">
                ...
                {/* Pending Review */}
                <Card className="bg-[#1F2227] border-yellow-700/60 rounded">
                    <CardContent className="p-3 sm:p-4 space-y-1.5">
                        <div className="flex items-center gap-2">
