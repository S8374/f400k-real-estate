  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-stone-950 to-stone-900">
      <div className="max-w-full mx-auto space-y-8 p-4 md:p-6">
        ...
        {/* Welcome Section */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-gradient-to-r from-emerald-900/20 to-transparent p-6 rounded border border-emerald-900/30">
          ...
          <div className="flex gap-4 bg-black/30 p-4 rounded">
