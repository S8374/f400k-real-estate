      ...
      <div className="max-w-full mx-auto space-y-10">
        ...
        <Card className="bg-stone-900/70 border-stone-800 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex flex-col sm:flex-row gap-4 bg-stone-950/50 border border-stone-800 rounded p-4">
                <Skeleton className="w-full sm:w-48 h-36 sm:h-32 rounded bg-gray-800" />
