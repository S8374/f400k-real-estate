...
import PropertyMap from "@/components/main/property-map/PropertyMap";
...
export default function ContactUs() {
  ...
  return (
    <section id="contact-us" className="text-white py-24">
      <Container>
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 items-stretch mt-10 md:mt-16">
          <div className="col-span-2 border-neutral-500 border rounded p-8 shadow-2xl h-full">
          ...
          <div className="flex flex-col justify-between border border-neutral-500 p-8 rounded shadow-2xl h-full gap-6">
            <div>
            ...
            <div className="space-y-6">
              <Card className="bg-stone-900 border-white/10 p-6">
                ...
                <div className="relative bg-zinc-800 rounded overflow-hidden mb-4 h-[250px] w-full">
                  <PropertyMap
                    isMapActive={true}
                    properties={[
                      {
