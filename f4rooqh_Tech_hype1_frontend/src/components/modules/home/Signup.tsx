          ...
          <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Tabs
                ...
                className="w-full"
              >
                <TabsList className="grid w-full grid-cols-2 bg-neutral-800 h-14 rounded p-1">
                  <TabsTrigger
                    value="buyer"
                    className="data-[state=active]:bg-emerald-800 data-[state=active]:text-white rounded"
                  >
                    Investor/Buyer
                  </TabsTrigger>
                  <TabsTrigger
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 bg-transparent border-white/50 text-white placeholder:text-gray-400 rounded h-12"
                      {...register("fullName", {
                  ...
                  <>
                    <div className="space-y-2 w-full">
                      ...
                      <div className="relative w-full">
                        ...
                        <Select>
                          <SelectTrigger className="w-full pl-12 bg-transparent border-white/50 text-white rounded h-12">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-12 pr-12 bg-transparent border-white/50 text-white placeholder:text-gray-400 rounded h-12"
                    {...register("password", {
