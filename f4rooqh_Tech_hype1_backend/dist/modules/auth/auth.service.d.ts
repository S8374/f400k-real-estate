...
export declare class AuthService {
    ...
    constructor(prisma: PrismaService, mailService: MailService, cacheManager: Cache);
    register(dto: RegisterAuthDto): Promise<UserEntity>;
    ...
    verifyResetOtp(dto: VerifyOtpDto, res: Response): Promise<{
        message: string;
        exchangeToken: any;
    }>;
    resetPassword(dto: ResetPasswordDto, req: Request, res: Response): Promise<{
        message: string;
    }>;
    ...
    adminLogin(dto: LogInAuthDto, res: Response): Promise<{
        accessToken: any;
        refreshToken: any;
        user: UserEntity;
    }>;
    ...
    changePassword(dto: ChangePasswordDto): Promise<UserEntity>;
