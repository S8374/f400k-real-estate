...
export declare class PaymentPlanController {
    ...
    create(user: any, dto: CreatePaymentPlanDto): Promise<{
        success: boolean;
        message: string;
        data: {
            property: {
    ...
    getPlansByCreator(creatorId: string, propertyId?: string): Promise<{
        success: boolean;
        message: string;
        data: {
            plans: {
    ...
    getPlansByBuyer(buyerId: string, propertyId?: string): Promise<{
        success: boolean;
        message: string;
        data: {
            plans: {
