...
function getOtpEmail(otp) {
    return `
    <div style="${(0, styles_1.getBaseStyle)()} box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); padding: 40px 30px;">
      <div style="${(0, styles_1.getHeaderStyle)()} border-bottom: none; padding-bottom: 0;">
      ...
      <div style="${(0, styles_1.getFooterStyle)()} margin-top: 40px; padding-top: 25px;">
