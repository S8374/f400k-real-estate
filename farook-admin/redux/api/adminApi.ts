...
export const adminApi = baseApi.injectEndpoints({
  ...
  endpoints: (builder) => ({
    ...
    getPaymentDetailsByAdmin: builder.query<any, { id: string; adminId: string }>({
      query: ({ id, adminId }) => ({
        url: `/admin/milestone-payments/details/${id}/${adminId}`,
        method: "GET",
      }),
      transformResponse: (response: any) => response?.data?.data || response?.data || response,
      providesTags: (_result, _error, arg) => [{ type: "Properties", id: `PAYMENT_${arg.id}` }],
    }),
    ...
    deletePropertyByAdmin: builder.mutation({
      query: (propertyId) => ({
        url: `/property/delete/${propertyId}`,
        method: "DELETE",
      }),
      invalidatesTags: ["Properties", "Agent"],
    }),
    ...
    createDeveloper: builder.mutation({
      ...
      invalidatesTags: ["users", { type: "users", id: "DEVELOPERS" }],
    }),
    ...
    getDeveloper: builder.query({
      ...
      providesTags: ["users", { type: "users", id: "DEVELOPERS" }],
    }),
    ...
    getDeveloperById: builder.query({
      ...
      providesTags: (_result, _error, id) => [{ type: "users", id: `DEVELOPER_${id}` }],
    }),
    ...
    createZone: builder.mutation({
      ...
      invalidatesTags: ["users", { type: "users", id: "ZONES" }],
    }),
    getAllZones: builder.query({
      ...
      providesTags: ["users", { type: "users", id: "ZONES" }],
    }),
    getZoneById: builder.query({
      ...
      providesTags: (_result, _error, id) => [{ type: "users", id: `ZONE_${id}` }],
    }),
